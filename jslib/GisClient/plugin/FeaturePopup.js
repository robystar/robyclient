Ext.define('GisClient.plugin.FeaturePopup', {
    mixins: {
        observable: 'Ext.util.Observable'
    },
	
    alias : 'plugin.gc_featurepopup',
    alternateClassName : 'GisClient.FeaturePopup',
    ...
    init: function(mapPanel){
		...
		mapPanel.on('loadqueryresult',this.showResult,this);
